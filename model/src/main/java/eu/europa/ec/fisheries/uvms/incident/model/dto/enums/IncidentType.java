...
public enum IncidentType {
    ...
    OWNER_TRANSFER(StatusEnum.PARKED, StatusEnum.RESOLVED),
    PARKED(StatusEnum.PARKED, StatusEnum.RECEIVING_AIS_POSITIONS, StatusEnum.RESOLVED),
    MANUAL_MODE(StatusEnum.MANUAL_POSITION_MODE, StatusEnum.MANUAL_POSITION_LATE, StatusEnum.RECEIVING_VMS_POSITIONS, StatusEnum.RESOLVED);
